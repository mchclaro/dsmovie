...
function TermsOfUser() {
    return (
        <body>
            <h1>Termo de Uso</h1>
            <div>
                <p>Atualizado em Maio de 2022</p>
            </div>
            ...
            <h2>Política de Cookies Projeto LGPD</h2>
            ...
            <ul>
                ...
                <p>Se você criar uma conta connosco, usaremos cookies para o
                    ...
                    as preferências do seu site ao sair.</p>
                ...
                <p>Utilizamos cookies quando você está logado, para que possamos
                    ...
                    acessar apenas a recursos e áreas restritas ao efetuar login.</p>
                <li>Cookies relacionados a boletins por e-mail</li>
                <p>Este site oferece serviços de assinatura de boletim
                    informativo ou e-mail e os cookies podem ser usados ​​para lembrar se você já está registrado e se deve
                    mostrar determinadas notificações válidas apenas para usuários inscritos / não inscritos.</p>
                <li>Pedidos processando cookies relacionados</li>
                <p>Este site oferece facilidades de comércio eletrônico
                    ou pagamento e alguns cookies são essenciais para garantir que seu pedido seja lembrado entre as
                    páginas, para que possamos processá-lo adequadamente.</p>
                <li>Cookies relacionados a pesquisas</li>
                <p> Periodicamente, oferecemos pesquisas e questionários para
                    ...
                    fornecer resultados precisos após a alteração das páginas.</p>
                <li>Cookies relacionados a formulários</li>
                <p>Quando você envia dados por meio de um formulário como os
                    encontrados nas páginas de contacto ou nos formulários de comentários, os cookies podem ser configurados
                    para lembrar os detalhes do usuário para correspondência futura.</p>
                <li>Cookies de preferências do site</li>
                <p>Para proporcionar uma ótima experiência neste site, fornecemos
            ...
            <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o projetoLGPD oferece no site
                e com caráter enunciativo, mas não limitativo:</p>
            <ul>
            ...
            <p>Esta política é efetiva a partir de Maio/2022.</p>
        </body>
    );
}
